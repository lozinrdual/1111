...
function AnimatedLink({
  ...
  return (
    <Link
      href={href}
      className="flex items-center justify-between w-full max-w-lg bg-secondary-cta px-4 md:px-0 py-3 md:py-4 border-t border-border text-sidebar-foreground font-medium text-lg md:text-xl hover:bg-secondary-cta-hover transition-all duration-300 ease-out group cursor-pointer"
    >
...
export function ServicesSection() {
  ...
  return (
    <section className="w-full bg-background py-0 md:py-20 lg:py-0 px-3 md:px-6 lg:px-8">
      <style>{`
      ...
      <div className="max-w-full mx-auto">
        <div className="space-y-0 md:space-y-2 overflow-hidden -mt-2 md:mt-0" ref={servicesRef}>
          <h2 className="text-5xl lg:text-8xl font-medium text-chart-5 mb-0 leading-none tracking-tighter">
